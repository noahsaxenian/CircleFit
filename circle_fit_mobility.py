...
class CircleFit:
    ...
    def filter_data(self, freq_range=None):
        ...
        if freq_range:
            ...
            below_peak = self.data['amplitude'] <= peak_amplitude * 1.1
            ...
            for i in range(closest_index - 1, -1, -1):
                if above_threshold[i] and below_peak[i]:
                    start_index = i
                else:
                    break
    ...
    def calculate_resonant_frequency(self):
        ...
        try:
            ...
            self.resonant_frequency = round(frequencies_dense[index], 1)
    ...
    def calculate_modal_parameters(self):
        ...
        Calculates residual """
        magA = (self.omega_r) * self.damping * (2 * self.r)
        self.phase = self.theta
